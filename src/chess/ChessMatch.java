...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        if (movedPiece instanceof Pawn && (target.getColumn() == source.getColumn() - 2 || target.getColumn() == source.getColumn() + 2)) {
    ...
    private boolean testCheck(Color color) {
        ...
        for (Piece p : opponentPieces) {
            boolean[][] possibleOpponentMoves = p.possibleMoves();
            if (possibleOpponentMoves[kingPosition.getRow()][kingPosition.getColumn()]) {
                return true;
            }
        }
        return false;
